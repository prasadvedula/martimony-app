...
import { buildChartData, getSignLabel, type ChartLanguage } from '@/lib/kundali/chart'
...
export function ProfileBirthChart({ name, dateOfBirth, nakshatra, rashi }: Props) {
